...
class TestDHCPSchedulerWithNetworkAccessibility(
    ...
    def test_dhcp_scheduler_filters_hosts_without_access_to_network(self):
        helpers.register_dhcp_agent(host='host1')
        helpers.register_dhcp_agent(host='host2')
        helpers.register_dhcp_agent(host='host3')
